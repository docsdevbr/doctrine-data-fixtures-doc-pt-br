:source_url: https://github.com/doctrine/data-fixtures/blob/3.0.x/docs/en/how-to/loading-fixtures.rst
...
``append: true`` para o método ``execute()``:
...
Por padrão, o ``ORMExecutor`` encapsulará o expurgo e o carregamento dos
...
esgotamento de tempo), você pode querer encapsular o expurgo e a carga de cada
fixture em sua própria transação.
